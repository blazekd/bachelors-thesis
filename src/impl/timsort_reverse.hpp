...
protected:
     ...
     * @param sorted first sorted element iterator. Must be lo <= start < hi
     */
...
public:
    ...
    TimSortReverse(It _first, It _last, Compare _comp) {
 ...
 */
template <class It, class Compare>
void timsort_rev(It first, It last, Compare comp) {
    TimSortReverse<It, Compare> tim(first, last, comp);
    tim.sort();
}
 ...
 */
template <class It>
void timsort_rev(It first, It last) {
    timsort_rev(first, last, std::less<>());
}
